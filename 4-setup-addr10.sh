...
adventure evm bench erc20-init 100000000000000000000000 -i http://127.0.0.1:8123 -a ./config/devnet/acc_pri_10 -s 5e3b90aaeec4e3d183044af82167ee799cd3ff5abdd912b9dd89b76e0fd006c4 2>&1 | tee temp_output.txt

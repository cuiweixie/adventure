...
adventure evm bench erc20-init 100000000000000000000000 -i http://127.0.0.1:8123 -a ./config/devnet/acc_pri_10_combined_30 -s 59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d 2>&1 | tee temp_output.txt
